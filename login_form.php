...
<body>
			<form id="login_form1" class="form-signin" method="post">
						...
						<button data-placement="right" title="Click Here to Sign In" name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-large"></i> Sign in</button>
						<button title="Click Here to clear" name="clear" class="btn btn-danger" type="reset"><i class="icon-refresh icon-large"></i> Clear</button>
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to SASTRA Learning Management System", { header: 'Access Granted' });
									var delay = 2000;
									...
									{
									$.jGrowl("Username and Password are incorrect", { header: 'Login Failed' });
									}
									}
								});
								return false;
			...
			New to SASTRA E-learning Website
			<hr>
