			...
			<button name="login" class="btn btn-info" type="submit"><i class="icon-check icon-large"></i> Sign in</button>
			<button name="clear" class="btn btn-danger" type="reset"><i class="icon-refresh icon-large"></i> Clear</button>
			</form>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to SASTRA E-Learning Management System", { header: 'Sign up Success' });
						var delay = 2000;
